 ...
 * 
 * MBUDPClientInboundHandler.java at 2021-6-29 10:24:09, code by Jack Jiang.
 */
...
//		
//		logger.info("[IMCORE-netty]evt="+evt+", evt.class="+evt.getClass().getName());
//		
//		if (evt instanceof IdleStateEvent) {
//            IdleStateEvent event = (IdleStateEvent)evt;
//            if (event.state() == IdleState.READER_IDLE) {
//            	logger.info("[IMCORE-netty]"+ctx.channel()+"的会话已超时失效，很可能是对方非正常通出或网络故障，即将执行会话关闭流程 ...");
//    			serverCoreHandler.sessionClosed(ctx.channel());
//            }
//        } else {
